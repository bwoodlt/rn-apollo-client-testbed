...
export type NextLaunchQueryVariables = Types.Exact<{ [key: string]: never }>;
...
export type LaunchListQueryVariables = Types.Exact<{ [key: string]: never }>;
...
export const NextLaunchDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'NextLaunch' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'launchNext' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'launch_date_unix' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'launch_site' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'reddit_campaign' },
                      },
                    ],
                  },
                },
...
} as unknown as DocumentNode<NextLaunchQuery, NextLaunchQueryVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'launch_success' },
                },
...
export const LaunchListDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'LaunchList' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<LaunchListQuery, LaunchListQueryVariables>;
